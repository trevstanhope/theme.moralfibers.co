...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix">
  ...
  <div class="content">
  <?php 
  		$artist_nid = $node->field_tshirt_artist[0]['nid']; 
  		$artist = node_load($artist_nid);
  		//dsm($node);	
  ?>
	
	<div class="product-header">
	  <span class="product-name"><?php print $node->title; ?></span> 
		<span class="artist-name">BY: <?php print $artist->title; ?></span>		
	</div>	
