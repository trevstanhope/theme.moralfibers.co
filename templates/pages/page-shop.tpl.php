  ...
  <div id="header-fixed">
  	<div id="header-fixed-container">
			<div class="region-wrapper">
	  		...
	  		<?php if ($top_right): ?>
	  			<?php //print moralfibers_user_bar(); ?>
					<?php print $top_right; ?>
	  		<?php endif ?>
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <span class="shop-left"><a href="/mens-shirts"><img src="/<?php print drupal_get_path('theme', 'moralfibers'); ?>/images/mens_styles.png" /></a></span>
        <span class="shop-right"><a href="/womens-shirts"><img src="/<?php print drupal_get_path('theme', 'moralfibers'); ?>/images/womens_styles.png" /></a></span>
        ...
        <div id="content-area">
          <?php print $content; ?>
			...
			<div id="home-secondary">
				<?php if (!empty($artist_of_the_week)): ?>
					<?php print $artist_of_the_week; ?>
				<?php endif ?>
				
				<?php if (!empty($our_mission)): ?>
					<?php print $our_mission; ?>
				<?php endif ?>
				
				<?php if (!empty($amazing_stories)): ?>
					<?php print $amazing_stories; ?>
				<?php endif ?>
			</div>
	...
	<?php print $content_bottom; ?>	
		...
		<div id="questions-contact-section">
			<?php if (!empty($address)): ?>
				<?php print $address; ?>
			<?php endif ?>
